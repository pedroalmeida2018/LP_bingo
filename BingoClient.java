...
public class BingoClient extends JFrame {
            ...
            while ((resposta = in.readLine()) != null) {
                ...
                if (resposta.startsWith("CARTAO;")) {
                    ...
                    SwingUtilities.invokeLater(() -> {
                        ...
                        // Desliga os botões após o fim do jogo
                        lineButton.setEnabled(false);
                        bingoButton.setEnabled(false);
                        
                        // Apaga todos os números no cartão
                    ...
                    SwingUtilities.invokeLater(() -> {
                        statusLabel.setText(msg);
                        bingoButton.setEnabled(true); // Liga o botão para tentar novamente
                    });
                }
            }
        } catch (IOException e) {
    ...
    private void addDrawnNumber(int numero) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            // Liga o botão se o número estiver no cartão
